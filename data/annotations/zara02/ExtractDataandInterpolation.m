%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Script to preprocess the ucy data/zara02
%
...
H = dlmread('/media/hesl/OS/Documents and Settings/N1701420F/Desktop/pedestrians/ucy_crowd/data_zara02/H.txt');

fid = fopen('../data_zara/crowds_zara02.vsp');
...
pixel_adjustedFrameID(1, :) = floor(pixel_adjustedFrameID(1, :) / 12);
