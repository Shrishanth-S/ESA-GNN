...
pixel_pos_frame_ped_pinH(3,:) = pixel_pos_frame_ped_pinH(3,:) / 576;
pixel_pos_frame_ped_pinH(4,:) = pixel_pos_frame_ped_pinH(4,:) / 720;

pixel_normalized(3,:) = 2*(pixel_normalized(3,:) / 576)-1;
pixel_normalized(4,:) = 2*(pixel_normalized(4,:) / 720)-1;
