%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Script to preprocess the ucy data/zara01
%
...
H = dlmread('/media/hesl/OS/Documents and Settings/N1701420F/Desktop/pedestrians/ucy_crowd/data_zara01/H.txt');

fid = fopen('../data_zara/crowds_zara01.vsp');
...
pixel_adjustedFrameID(1, :) = floor(pixel_adjustedFrameID(1, :) / 8);
